...
https = str(input("> Enable https(y/n) (default=n):"))
url = str(input("> Page you want to attack(default=/):"))
port = str(input("> Port(default=80):"))
if port == '':
	print("[!] Port 80 was chosen")
	port = int(80)
else:
	print("[!] Port",port,"was chosen")
	port = int(port)
...
if thread_num == '':
	...
	print("[!]",thread_num,"threads")
	thread_num = int(thread_num)
N = str(input("> Do you need to get socks5 list from web?(y/n) (default=n):"))
if N == 'y':
    r = requests.get("https://www.proxy-list.download/api/v1/get?type=socks5")
    with open("socks.txt",'wb') as f:
        f.write(r.content)
    print("\r\n [!] Have already downloaded socks5 list as socks.txt\r\n")
else:
    pass
out_file = str(input("> Proxy file path(default=socks.txt):"))
if out_file == '':
